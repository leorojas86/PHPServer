class InventoryServiceMock {
  ...
  constructor() {
    ...
    this.items = [
      ...
      { id:'1', name:'folder 1', path:['#', 'folder 1'], type:'folder', children:['3'], pathIds:['0'] },
      { id:'2', name:'file 1', path:['#', 'file 1'], type:'file', pathIds:['0'] },
      { id:'3', name:'folder 2', path:['#', 'folder 1', 'folder 2'], type:'folder', children:[], pathIds:['0','1'] },
    ];
