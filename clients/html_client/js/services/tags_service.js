...
function TagsServiceClass()
{
	this.updateSearchTags = function(groupId, data, type)
	{
		...
		ServiceClient.instance.request(App.instance.ENVIRONMENT.SERVICES.TAGS.URL, "POST", payload, function(result) {});//TODO: Handle result
	};
	...
	this.searchGroups = function(searchText, types, callback)
	{
		...
		ServiceClient.instance.request(App.instance.ENVIRONMENT.SERVICES.TAGS.URL, "POST", payload, function(resultData) { onSearchGroupsCallback(resultData, callback); });
	};
